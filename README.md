...
担当ファイル：
- UI.pde - スタート画面、ゲームオーバー画面
- LeftPanel.pde - 左側の市場情報表示
- RightPanel.pde - 右側のゲーム画面表示
- Popup.pde - ポップアップウィンドウ
- CardVisual.pde - カードの見た目

具体的なタスク：
- ✏️ スタート画面のデザインと実装
- ✏️ 市場情報の表示（価格、在庫数、環境効果）
- ✏️ プレイヤーの手札・出荷エリアの表示
- ✏️ 買付・出荷選択のポップアップ
- ✏️ カードのビジュアルデザイン
- ✏️ ボタンのデザインと配置
...
担当ファイル：
- Market.pde - 市場の処理
- RiceCard.pde - カードデータ構造
- GameState.pde - ゲーム状態管理
- GameLogic.pde - ゲーム進行ロジック

具体的なタスク：
- ⚙️ 価格計算アルゴリズム（供給量による変動）
- ⚙️ 在庫管理システム（消費処理）
- ⚙️ 環境効果の実装（豊作、不作、台風、豊穣祭）
- ⚙️ ターン管理（10ターンで終了）
- ⚙️ 勝敗判定（所持金比較）
- ⚙️ カードの古米化処理
